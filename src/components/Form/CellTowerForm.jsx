...
function CellTowerForm({handleYourDetailsChange}) {
    ...
    <div className="input-wrapper-details">
      <div className="user-name">
        ...
        <Select options={['Bharti Airtel', 'Jio Infocom', 'Vodafone Idea', 'Bharat Sanchar Nigam']} clasname="organization" defaultSelectName="Select" selectedValue={yourDetail.organizationName} changeHandler={(organization) => {handleYourDetailsChange(organization, 'organizationName'); setYourDetail((currentValue) => { return { ...currentValue, organizationName: organization } })}} />
      </div>
      <div className="user-number">
