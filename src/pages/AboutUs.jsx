    ...
    <div>
      <Header />
        <div className="video_holder">
          <img src={videoBg} alt="video_img" className="video_img" />
          <img src={videoPlay} alt="video_img" className="play_img" />
        </div>
            ...
            <div className="content_holder">
                <div className="section_left">
                  <div className="image_holder float_left">
                    <img src={sectionImg1} alt="section_img" className="section_img" />
                  </div>
                ...
                <div className="section_left">
                  ...
                  <div className="image_holder float_right">
                    <img src={sectionImg2} alt="section_img" className="section_img" />
                  </div>
                </div>
                ...
                <div className="section_left">
                  ...
                  <div className="image_holder float_left">
                    <img src={sectionImg3} alt="section_img" className="section_img" />
                  </div>
                </div>
            </div>
        </div>
