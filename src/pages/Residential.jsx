...
import pageData from "../data/residential";
import Landing from "./Landing";

function Residential({language}) {
		...
		<div className="page residential">
			...
			<section className="section">
				<div className="container curved-card-wrapper">
					{
						pageData[language].curvedCard.map((card, index) => <CurvedCard title={card.title} text={card.text} />)
					}
				</div>
			</section>
